...
class Nav2ParamDef:
    ...
    # yet wired to a restart notification (see docs/dev-notes.md "Ideas for
    # review"). BACKLOG.md is auto-regenerated by scripts/nav2_param_gap.py and
    # cannot hold hand-written notes.
